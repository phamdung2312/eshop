...
const Faq = () => {
  ...
  return (
    <>
      <Meta title="Câu hỏi thường gặp"></Meta>
        ...
        <div className="mx-auto space-y-4">
            ...
            {activeTab === 3 && (
              <div className="mt-4">
                <p className="text-base text-gray-500">
                  ...
                  liên kết theo dõi trong email xác nhận giao hàng hoặc bằng
                  cách đăng nhập vào tài khoản của bạn trên trang web của chúng
                  tôi và xem các chi tiết đặt hàng.
                </p>
              </div>
            )}
          </div>
          ...
          <div className="border-b border-gray-200 pb-4">
            ...
            {activeTab === 4 && (
              <div className="mt-4">
                <p className="text-base text-gray-500">
                  Bạn có thể liên hệ với nhóm hỗ trợ khách hàng của chúng tôi
                  bằng cách gửi email cho chúng tôi tại support4d@gmail.com hoặc
                  gọi cho chúng tôi theo số 0965686542 trong khoảng thời gian từ
                  6 giờ sáng đến 22 giờ tối tất cả các ngày trong tuần.
                </p>
              </div>
            )}
          </div>
            ...
            {activeTab === 5 && (
              <div className="mt-4">
                <p className="text-base text-gray-500">
                  ...
                  không thể thực hiện thay đổi hoặc hủy bỏ. Nếu bạn không còn
          ...
          <div className="border-b border-gray-200 pb-4">
            ...
            {activeTab === 7 && (
              <div className="mt-4">
                <p className="text-base text-gray-500">
                  Chúng tôi chấp nhận thanh toán bằng visa, mastercard, paypal
                  và thanh toán bằng tiền mặt khi nhận hàng trên hệ thống giao
                  hàng.
                </p>
              </div>
            )}
